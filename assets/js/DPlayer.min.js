(function(je,X){typeof exports=="object"&&typeof module=="object"?module.exports=X():typeof define=="function"&&define.amd?define("DPlayer",[],X):typeof exports=="object"?exports.DPlayer=X():je.DPlayer=X()})(self,()=>(()=>{var je={916:(u,v,f)=>{var z=f(471);u.exports=function(I){"use strict";var x,p="",C=(I=I||{}).video,B=I.options,y=z.$escape,L=I.tran,O=I.icons,S=I.index,D=z.$each;return I.$value,I.$index,p+=`<div class="dplayer-mask"></div>
...
<button class="dplayer-mobile-play">
    `,p+=O.play,p+=`
</button>`}},568:(u,v,f)=>{var z=f(471);u.exports=function(I){"use strict";var x="",p=(I=I||{}).enableSubtitle,C=I.subtitle,B=I.current,y=I.airplay,L=I.pic,O=z.$escape,S=I.screenshot,D=I.preload,j=I.url;return p=C&&C.type==="webvtt",x+=`
<video
    ...
    `),x+`
</video>`}},49:(u,v,f)=>{"use strict";f.d(v,{Z:()=>C});var z=f(415),I=f.n(z),x=f(352),p=f.n(x)()(I());p.push([u.id,`:root {
...
[aria-label][data-balloon-pos] {
  ...
  [aria-label][data-balloon-pos][data-balloon-length="fit"]:after {
    width: 100%; }
`],sourceRoot:""}]);const C=p},685:(u,v,f)=>{"use strict";f.d(v,{Z:()=>D});var z=f(415),I=f.n(z),x=f(352),p=f.n(x),C=f(49),B=f(80),y=f.n(B),L=new URL(f(831),f.b),O=p()(I());O.i(C.Z);var S=y()(L);O.push([u.id,`@keyframes my-face {
  2% {
